...
test('renders correctly', async () => {
  ...
  expect(wrapper.state('images')).toHaveLength(0);
  ...
  await wrapper.instance().filterSearch("failure");
  expect(wrapper.state('images')).toHaveLength(0);
  await wrapper.instance().filterSearch("working");
